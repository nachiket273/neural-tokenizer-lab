...
from neural_tokenizer.neural_v1_eval import (
    evaluate_neural_v1_bpb,
)
from neural_tokenizer.neural_v1_model import (
    NeuralV1LanguageModel,
)
from neural_tokenizer.neural_v1_training import (
    train_neural_v1,
)
...
OUTPUT_DIR = Path("experiments/neural_v1")
...
def main():
    ...
    validation_bpb = evaluate_neural_v1_bpb(
        model=model,
        texts=valid_texts,
        tokenizer=tokenizer,
        device=DEVICE,
